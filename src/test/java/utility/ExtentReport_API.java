...
public class ExtentReport_API implements ITestListener {
	...
	String rep;
	 ...
	 public void onStart(ITestContext context) {
		 ...
		 rep = "Kora Dream API -Report-" + timeStemp + ".html";
		 
		 sparkReporter = new ExtentSparkReporter(".//reports//" + rep);
		 sparkReporter.config().setDocumentTitle("Kora Dream");
		 sparkReporter.config().setReportName("Kora Dream API testing");
		 sparkReporter.config().setTheme(Theme.DARK);
		 	 
		 extent =new ExtentReports();
		 extent.attachReporter(sparkReporter);
		 	 
		 extent.setSystemInfo("Application", "Kor Dream");
		 extent.setSystemInfo("Module Name", "User API");
	   ...
	   public void onTestSuccess(ITestResult result) {
		  ...
		  public void onTestFailure(ITestResult result) {
			    ...
			    try {
			        ...
			        WebDriver driver = ((BaseTest) currentClass).driver; // cast to your base class that has driver
